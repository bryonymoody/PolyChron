...
def gibbs_code(
    ...
    for i in range(0, iter_num):
        for k in range(len(THETA_INITS)):
            SITE_DICT_TEST_1 = dict_update(
                SITE_DICT_TEST_1, POST_THETAS, POST_PHIS, i, i, POST_PHASE, PHI_REF, TOPO_SORT
            )
            key = KEY_REF[k]
...
def step_2_squeeze(
    ...
    f_phi2 = (s2 ** (2 - M)) / (R - s2)
    SITE_DICT_TEST_3 = dict_update(
        SITE_DICT_TEST_3, POST_THETAS, POST_PHIS, i + 1, i + 1, POST_PHASE, PHI_REF, TOPO_SORT
    )
...
def step_3_squeeze(
    ...
    SITE_DICT_TEST_4 = dict_update(
        SITE_DICT_TEST_4, POST_THETAS, POST_PHIS, i + 2, i + 2, POST_PHASE, PHI_REF, TOPO_SORT
    )
...
def step_4_squeeze(
    ...
    SITE_DICT_TEST_5 = dict_update(
        SITE_DICT_TEST_5, POST_THETAS, POST_PHIS, i + 3, i + 3, POST_PHASE, PHI_REF, TOPO_SORT
    )
