...
class RemoveContextView(ttk.Frame):
    ...
    def __init__(self, root: tk.Tk):
        ...
        self.label=tk.Label(self.top,text="Why are you removing this context from your stratigraphy?", bg ='white', font='helvetica 12', fg = '#2f4858')
