...
class TestModelPresenter:
    ...
    def test_init(self, mock_update_view):
        ...
        assert mock_view.bind_littlecanvas_callback.call_args.args[0] == "<Button-3>"
    ...
    def test_nodecheck(self):
        ...
        tests_coords = [
            ...
            # [[33.76, 72.01], "box"],  # inside the corner of the box. Todo
            [[32.75, 72.0], "no node"],  # on the corner of  box
            [[31.75, 71.0], "no node"],  # outside corner box
            [[59.745, 18.0], "diamond"],  # mid diamond
            [[-0.10, +0.1], "diamond"],  # inside corner diamond, would be no_node ideally
