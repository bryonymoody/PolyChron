...
class TestSplashPresenter:
    ...
    def test_on_select_project(
        ...
        This instantiates a separate presenter and makes it visible, however created Presenter is not acceessible outside of the method, so we can only check that the patched and moccked constructors were called.
        """
