...
class TestManageGroupRelationshipsView:
    """Tests for the ManageGroupRelationshipsView.
    ...
    def test_is_importable(self):
        """Test that the ManageGroupRelationshipsView class has successfully been imported, but do not attmept to actually test the class"""
        # Assert the module was loaded
        assert "polychron.views.ManageGroupRelationshipsView" in sys.modules
        # Assert the specific class now exists, but do not instantiate it
        assert isinstance(ManageGroupRelationshipsView, type)
