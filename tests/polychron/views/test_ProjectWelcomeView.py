...
class TestProjectWelcomeView:
    """Tests for the ProjectWelcomeView.
    ...
    def test_is_importable(self):
        """Test that the ProjectWelcomeView class has successfully been imported, but do not attmept to actually test the class"""
        # Assert the module was loaded
        assert "polychron.views.ProjectWelcomeView" in sys.modules
        # Assert the specific class now exists, but do not instantiate it
        assert isinstance(ProjectWelcomeView, type)
